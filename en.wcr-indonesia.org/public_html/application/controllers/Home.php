...
class Home extends MY_API
{
    ...
    public function view($action = null)
    {
        $company_id = $this->company_id;
          ...
          // Collect data
          $result = $this->db->query('SELECT * FROM products WHERE company_id="'.$company_id.'" AND slug="'.$slug.'"')->result();
      		if(@$result[0]->id == NULL){
              show_404();
            }
    ...
    public function product_category($slug)
    {
        ...
        $company_id = $this->company_id;
          ...
          if ($slug === 'all' || $slug === '') {
              ...
              $query = $this->db->query("SELECT * FROM products WHERE company_id='".$company_id."' AND draft='0' ORDER BY created_at DESC LIMIT ".@$page.",".@$per_page." ");
              ...
              $cat_data = $this->db->query('SELECT * FROM packages WHERE company_id="'.$company_id.'" AND slug="'.$slug.'"')->result();
              $id       = @$cat_data[0]->id;
              $cat      = @$cat_data[0]->name;
               // Pagination
              $page_position = ($opt_page)? (int)$opt_page: 1;
              ...
              $query = $this->db->query("SELECT * FROM products WHERE package_id='".$id."' AND company_id='".$company_id."' AND draft='0' ORDER BY created_at DESC LIMIT ".@$page.",".@$per_page." ");
    ...
    public function blog_post($action = null)
    {
        $company_id = $this->company_id;
          ...
          // Collect data
          $result = $this->db->query('SELECT * FROM blog_post WHERE company_id="'.$company_id.'" AND slug="'.$slug.'"')->result();
          if(@$result[0]->id == NULL){
              show_404();
            }
    ...
    public function blog_category($slug = null)
    {
        ...
        $company_id = $this->company_id;
          ...
          if ($slug === 'all' || $slug === '') {
              ...
              $query = $this->db->query("SELECT * FROM blog_post WHERE company_id='".$company_id."' AND draft='0' ORDER BY created_at DESC LIMIT ".@$page.",".@$per_page." ");
              ...
              $cat_data = $this->db->query('SELECT * FROM blog_category WHERE company_id="'.$company_id.'" AND slug="'.$slug.'"')->result();
              $id       = @$cat_data[0]->id;
              $cat      = @$cat_data[0]->name;
               // Pagination
              $page_position = ($opt_page)? (int)$opt_page: 1;
              ...
              $query = $this->db->query("SELECT * FROM blog_post WHERE category_id='".$id."' AND company_id='".$company_id."' AND draft='0' ORDER BY created_at DESC LIMIT ".@$page.",".@$per_page." ");
