...
class MY_API extends CI_Controller {
    ...
    function generalData($company_id='')
    {
        ...
        // Collecting Category
        $review = $this->db->query('SELECT * FROM reviews WHERE company_id='.$this->company_id)->result();
        $blogCategory = $this->db->query('SELECT * FROM blog_category WHERE company_id='.$this->company_id)->result();
        $productCategory = $this->db->query('SELECT * FROM packages WHERE company_id='.$this->company_id)->result();
        $videoCategory = $this->db->query('SELECT * FROM video_category WHERE company_id='.$this->company_id)->result();
        $galleryCategory = $this->db->query('SELECT * FROM gallery_category WHERE company_id='.$this->company_id)->result();
