...
<section class="py-5" style="background: var(--colors);">
	<div class="container wow fadeInUp" data-wow-duration="2s">
		...
		<div class="row title-product mb-4 text-center justify-content-center">
	      <div class="col-md-8">
	          <h2 style="color: white;">Our Founders</h2>
	          <p style="color: #f1f1f1;">Through this platform, we introduce local heroes who fight to protect the rights of women, children and youth, and promote equality, social inclusion and sustainable development. </p>
	      </div>
	  </div>
