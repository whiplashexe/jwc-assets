  ...
  <?php 
    $_impact = json_decode(json_encode([
      ...
      'items' => [
        [
          'number' => 1500,
          'text' => 'people have received socialization from WCR',
        ],
        [
          'number' => 200,
          'text' => 'participants have been facilitated with training by WCR',
        ],
        [
          'number' => 60,
          'text' => 'institutional partners have collaborated with WCR',
        ],
      ]
    ]))
  ?>
