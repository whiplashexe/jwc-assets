...
<section class="py-5" style="background: var(--colors);">
	<div class="container wow fadeInUp" data-wow-duration="2s">
		
		<div class="row title-product mb-4 text-center justify-content-center">
	      <div class="col-md-8">
	          <h2 style="color: white;">People Behind</h2>
	          <p style="color: #f1f1f1;">Melalui platform ini, kami memperkenalkan para pahlawan lokal yang berjuang untuk melindungi hak-hak perempuan, anak-anak, dan pemuda, serta mempromosikan kesetaraan, inklusi sosial, dan pembangunan berkelanjutan. </p>
	      </div>
	  </div>
