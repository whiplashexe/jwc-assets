...
<section style="background-color: #f4f4f4; position: relative;" class="pt-3">
    <div class="container">
        <div class="row mb-2 py-3">
            ...
            <div class="col-4 position-relative"><a href=<?= base_url() .
              "tag/" .
              str_replace(
                " ",
                "-",
                $item->setting->criteria
              ) ?> class="btn btn-outline-primary custom">See More</a></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 slide-fixed pt-3 pb-2">
                <div class="pro-contain">
                    ...
                    <div class="pro-body">
                        <h3 class="pro-title mb-0"><a href="<?= $func->link(
                          $route,
                          $item->slug
                        ) ?>"><?= $item->title ?></a></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <p class="mb-0 text-right pro-price"><span>IDR <?= number_format(
                                  $item->price,
                                  0,
                                  0,
                                  "."
            ...
            <div class="col-md-3 mb-4 display-ba">
                ...
                <div class="wrap-content mt-2">
                     ...
                     <div class="row">
                         ...
                         <div class="col-7" style="padding-left: 0px;">
                            <?php if (
                             ...
                             <p class="style-price text-right">IDR <?= number_format(
                               $hasilcon,
                               0,
                               0,
                               "."
                             ...
                             <?php elseif (
                              ...
                              $_GET["usd"] == 1
                                ...
                                <p class="style-price text-right">USD <?= number_format(
                                  $items->price,
                                  0,
                                  0,
                                  "."
                             ...
                             <?php else: ?>
                                <p class="style-price text-right"><?= $func->price(
                                  $items,
                                  "usd"
                                ) ?></p>
                            <?php endif; ?>
                    ...
                    <?php endif; ?>
                         ...
                         <p class="content-pro-baru"><?= $func->trailer(
                           $items,
                           150
                         ) ?></p>
                        ...
                        <div class="row justify-content-center py-3">
                            <div class="col-6">
                                <a class="btn btn-baru1" href="<?= $func->link(
                                  ROUTE_PRODUCT_VIEW,
                                  $items->slug
                                ) ?>">Detail</a>
                            </div>
        ...
        <div class="col-md-12 mb-3" style="padding: 0;">
            ...
            <?php if ($items->price != 0 && $items->price != ""): ?>
                <?php if (isset($_GET["idr"]) && $_GET["idr"] == 1): ?>
                 ...
                 <p class="style-price text-center" style="font-size: 17px;">IDR <?= number_format(
                   $hasilcon,
                   0,
                   0,
                   "."
                 ...
                 <?php elseif (isset($_GET["usd"]) && $_GET["usd"] == 1): ?>
                    ...
                    <p class="style-price text-center" style="font-size: 17px;">USD <?= number_format(
                      $items->price,
                      0,
                      0,
                      "."
                 ...
                 <?php else: ?>
                    <p class="style-price text-center" style="font-size: 17px;"><?= $func->price(
                      $items,
                      "usd"
                    ) ?></p>
                <?php endif; ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center" style="top: 50px">
                <h2 class="section_title wow fadeInUp" style="font-family: StoneInformal;letter-spacing: 5px"><?= $item
                  ->setting->title ?></h2>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 wow bounceInDown">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offer_name" style="width:250px"><a href="<?= $func->link(
                                      ROUTE_PRODUCT_VIEW . $items->slug
                                    ) ?>"><?= $items->title ?></a></div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="offers_content wow fadeInUp ">
                                    <p class="offers_text wow fadeInUp wow fadeInUp"><?= $func->trailer(
                                      $items,
                                      250
                                    ) ?></p>
                                    <div class="offers_link wow fadeInUp "><a href="<?= $func->link(
                                      ROUTE_PRODUCT_VIEW . $items->slug
                                    ) ?>" title="<?= $items->title ?>">Read More<i class="fas fa-long-arrow-alt-right"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
