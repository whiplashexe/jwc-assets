...
<form id="contactForm" action="" method="POST">
	...
	<div class="form-row">
		<div class="form-group col-12">
			...
			<input type="text" value="<?= $data->result->custom_field_5 ?>" class="form-control" name="voucher" id="voucher" readonly>
		</div>
	</div>
