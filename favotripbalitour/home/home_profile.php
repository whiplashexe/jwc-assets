    ...
    <div class="container-global wow fadeIn" data-wow-duration="2s" style="z-index:3; position: relative;">
        <div class="row">
          ...
          <div class="col-md-7 mb-md-3 mb-0 d-flex align-items-end">
            <p>
              <strong>Favotrip Bali Tour</strong> is a professional travel agency offering Bali & Nusa Penida tours. With personalized service & competitive prices, we provide unforgettable experiences on the Island of Gods.
            </p>
          </div>
          <div class="col-md-5">
          ...
          <div class="col-md-7">
            <div class="img-rg row mx-0 w-100 mb-4">
              <div class="col-6 px-1">
                <img src="https://jwc.gotra-resources.my.id/web-upload/1739435728-product_image-13-02-2025-1QrywvCRci296Dth.jpg" alt="About Us" class="w-100" />
              </div>
              <div class="col-6 px-1">
                <img src="https://jwc.gotra-resources.my.id/web-upload/1739438044-13-02-2025-LUljOEKM5JWsqTfSp1cRiu8ghxYGBaV0.webp" alt="About Us" class="w-100" />
              </div>
            </div>
