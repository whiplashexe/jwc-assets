<header id="header" class="header-no-min-height" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 0, 'stickySetTop': '0'}">
	<div class="header-body">
		<div class="header-top header-top-colored header-top-light d-none d-lg-block">
			<div class="container">
				<div class="header-row py-2">								
					<div class="header-column justify-content-end">
						<div class="header-row">
							<ul class="header-social-icons social-icons d-none d-lg-block sosmed">
		...
		<div class="header-container container">					
			<div class="header-row">
				<div class="header-column">
					<div class="header-row">
						<div class="header-logo mg0">
							<a href="<?= base_url() ?>" title="<?= $data->web->site_name ?>">
								<img alt="<?= $data->web->site_name ?>" width="auto" height="80" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?= $data->web->site_logo ?>">
							</a>
						</div>
					</div>
				</div>
