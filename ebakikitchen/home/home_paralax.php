...
.paralax .background {
    ...
    background-image: url("https://gotra.sgp1.digitaloceanspaces.com/web-upload/1733141819-product_image-02-12-2024-TsIa8qy4dJUeWkQc.webp");
}
        ...
        <div class="container">
            <div class="text text-center">
                <h2 class="text-center text-light">
                    Bali’s top thrilling experiences await
                </h2>

                <p>
                    Unleash your inner adventurer with Bali’s heart-pounding activities, combining excitement and beauty for an unforgettable journey.
                </p>
