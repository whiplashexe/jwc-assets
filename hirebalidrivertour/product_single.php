...
<section style="" class="section-allpage lazyload" data-bgset="https://gotra.sgp1.digitaloceanspaces.com/web-upload/1741847252-13-03-2025-n956XKrvGfpsHYbRaSCMq8UwitJzPd2j.webp">
...
#_bookcar-root ._bookcar-watext a {
  color: var(--colors);
  font-family: var(--primtext);
}

#_bookcar-root ._bookcar-form-header {
  color: var(--colors);
  font-weight: bold;
  text-align: center;
...
#_bookcar-root ._bookcar-form-wrapper {
  width: 100%;
  max-width: 900px;
  margin: auto;
  display: grid;
  ...
  grid-template-areas: "car" "name" "email" "phone" "booking-date" "address" "pickup-time" "message" "submit";
}
...
#_bookcar-root ._bookcar-form-wrapper > div input, #_bookcar-root ._bookcar-form-wrapper > div textarea {
...
#_bookcar-root ._bookcar-form-wrapper > div span {
  font-size: clamp(.8rem, 2vw, 1rem);
}

#_bookcar-root ._bookcar-form-wrapper > div button {
  border: none;
...
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-car-wrapper {
  grid-area: car;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-name-wrapper {
  grid-area: name;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-email-wrapper {
  grid-area: email;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-phone-wrapper {
  grid-area: phone;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-booking-date-wrapper {
  grid-area: booking-date;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-address-wrapper {
  grid-area: address;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-pickup-time-wrapper {
  grid-area: pickup-time;
}
#_bookcar-root ._bookcar-form-wrapper ._bookcar-input-message-wrapper {
  grid-area: message;
}

#_bookcar-root ._bookcar-form-wrapper ._bookcar-form-btn-wrapper {
  grid-area: submit;
}
...
@media (min-width: 600px) {
  #_bookcar-root ._bookcar-form-wrapper {
    ...
    grid-template-areas: "car name" "email phone" "booking-date message" "address message" "pickup-time message" "submit submit"
  }
}

</style>

<section id="_bookcar-root" class="single-accomodation pad6rem">
  <div class="container-global d-flex flex-column justify-content-start align-items-stretch py-5">
    <p class="_bookcar-watext">Fill out the form below or click this number for faster response on WhatsApp: <a href="https://wa.me/<?= $data->social->whatsapp; ?>">+ <?= $data->social->whatsapp ?></a></p>

    <p class="_bookcar-form-header">Or please fill the form below :</p>

    <form class="_bookcar-form-wrapper" id="contactForm" action="https://secure-booking.gotrabook.com/direct" method="POST">
       <!-- <input type="hidden" name="to" value="<?= $data->company->company_email ?>"> -->
       <input type="hidden" name="to" value="<?= $data->company->company_email ?>">

        <div class="_bookcar-input-car-wrapper">
            <span>Car</span>
            <input required class="_bookcar-input-car" readonly name="car" value="<?= $data->result->title ?>">
        </div>
        <div class="_bookcar-input-name-wrapper">
            <span>Name</span>
            <input required class="_bookcar-input-name" name="name">
        </div>
        <div class="_bookcar-input-email-wrapper">
            <span>Email</span>
            <input required type="email" class="_bookcar-input-email" name="email">
        </div>
        <div class="_bookcar-input-phone-wrapper">
            <span>Phone</span>
            <input required type="tel" class="_bookcar-input-phone" name="phone">
        </div>
        <div class="_bookcar-input-booking-date-wrapper">
            <span>Booking Date</span>
            <input type="date" required class="_bookcar-input-booking-date" name="booking-date">
        </div>
        <div class="_bookcar-input-address-wrapper">
            <span>Address (Hotel, Airport, Etc)</span>
            <input required class="_bookcar-input-address" name="address">
        </div>
        <div class="_bookcar-input-pickup-time-wrapper">
            <span>Pickup Time</span>
            <input required class="_bookcar-input-pickup-time" name="pickup-time">
        </div>
        <div class="_bookcar-input-message-wrapper">
            <span>Message (Optional)</span>
            <textarea class="_bookcar-input-message" style="height: 100%;" name="message"></textarea>
        </div>
        <div class="_bookcar-form-btn-wrapper">
...
.btn-bok:hover {
    ...
    .wrap-exbook .btn-exbook.wa {
        background: #07BA39;
    }
    .wrap-exbook .btn-exbook.mail {
        background: #F53435;
    }
 ...
 -->             <?php if (!empty($data->result->custom_field_1)): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="wrap-exbook mb-4">
                        ...
                        <a class="btn btn-exbook wa" href="<?= $func->dm_whatsapp() ?>"><i class="fa-brands fa-whatsapp mr-3"></i>Have Questions?</a>
                        <!--<a class="btn btn-exbook mail" href="<?= $func->dm_email() ?>"><i class="fa-regular fa-envelope mr-3"></i>Book Via Email!</a>-->
