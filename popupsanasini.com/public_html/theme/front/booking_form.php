	...
	<div class="form-row">
	 ...
	 <?php
		if (isset($_POST['booking'])) {
		    header("location: https://api.whatsapp.com/send?phone=".str_replace('+', '', $data->social->whatsapp)."&text=Form%20booking%20%2A".$repl."%2A%0D%0A%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%20%0D%0AName%20%3A%20".str_replace(' ', '%20', $_POST['name'])."%0D%0ABooking%20Date%20%3A%20".str_replace(' ', '%20', $_POST['tourdate'])."%0D%0ANumber%20of%20People%20%3A%20".str_replace(' ', '%20', $_POST['tourparticipant'])."%0D%0AHotel%20%3A%20".str_replace(' ', '%20', $_POST['hotel'])."%0D%0ATour%20Packages%20%3A%20".str_replace(' ', '%20', $_POST['tourpackage'])."%0D%0ANote%20%28%20Optional%20%29%20%3A%20".str_replace(' ', '%20', $_POST['message'])."%0D%0A%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D");
		}?>
