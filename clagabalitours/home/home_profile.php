    ...
    <div class="container-global wow fadeIn" data-wow-duration="2s" style="z-index:3; position: relative;">
        <div class="row">
          ...
          <div class="col-md-7 mb-md-3 mb-0 d-flex align-items-end">
            <p>
              <strong>Wide Bali Tours</strong>  is a trusted travel service offering private tours, adventure packages, car rentals, and airport transfers in Bali. Enjoy a seamless, safe, and unforgettable journey with our expert local guides!
            </p>
          </div>
          <div class="col-md-5">
          ...
          <div class="col-md-7">
            <div class="img-rg row mx-0 w-100 mb-4">
              <div class="col-6 px-1">
                <img src="https://jwc.gotra-resources.my.id/web-upload/1739605394-product_image-15-02-2025-7czQ9YTePjDLi0ux.webp" alt="About Us" class="w-100" />
              </div>
              <div class="col-6 px-1">
                <img src="https://jwc.gotra-resources.my.id/web-upload/1739605391-product_image-15-02-2025-DdS4iUV3N7EYTtgZ.webp" alt="About Us" class="w-100" />
              </div>
            </div>
